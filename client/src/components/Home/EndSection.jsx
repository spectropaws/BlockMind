  ...
  return (
    <div className="bg-green-800/80 text-center py-16 px-4">
      ...
      <p className="text-white text-lg max-w-2xl mx-auto mb-8">
        Start using CropMind AI today and see how data-driven decisions can
        increase your yields and reduce costs.
      </p>
      <div className="flex justify-center space-x-4">
        <Button
          ...
          asChild
        >
          <Link to={"/crop-recomendation"}>Get Started Now &gt;</Link>
        </Button>
